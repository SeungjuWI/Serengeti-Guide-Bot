        ...
        blocks: [
          ...
          },
          {
            ...
            text: {
              type: "mrkdwn",
              text:
                "노션 *세렝게티 생활 가이드*와 *재무회계 가이드*를 검색해서 회사 생활 관련 질문에 답해드려요.\n" +
                "• *인사 · 복리후생*: 인사규정, 휴가, 경조사, 각종 지원 제도\n" +
                "• *근무환경*: 회의실/장비 예약, 오피스 시설, 계약, 자산관리\n" +
                "• *재무회계*: 전자결재, 지출결의서, 법인카드, 각종 증빙, 자금 집행 일정",
            },
          },
          { type: "divider" },
          {
