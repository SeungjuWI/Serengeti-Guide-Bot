...
const BUILTIN_PINS = [
  {
    ...
    notes: [
      "'조부모의 사망(본인)', '외조부모의 사망(본인)' 항목은 본인의 (외)조부모가 돌아가신 경우에 지원한다. " +
        "할머니·할아버지·외할머니·외할아버지는 본인의 (외)조부모이므로 표에 적힌 대로 지원 대상이다(휴가 3일, 조화+상조물품, 경조금 없음).",
      "다만 배우자의 (외)조부모(시조부모, 처조부모, 처외조부모, 시외조부모 등)는 이 두 항목의 지원 대상이 아니다. " +
        "이 제한은 조부모·외조부모 항목에만 적용된다. 다른 항목의 지원 범위는 표의 괄호 표기를 그대로 따른다 " +
        "(예: '부모의 사망(본인, 배우자)'은 배우자의 부모도 지원 대상).",
    ],
  },
];
